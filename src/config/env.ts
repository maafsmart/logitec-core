...
const envSchema = z.object({
  ...
  PDA_GRANT_PEPPER: z.string().min(32, "PDA_GRANT_PEPPER must have at least 32 characters").optional(),
  ...
  if (value.NODE_ENV === "production" && !value.PDA_GRANT_PEPPER) {
    context.addIssue({
      code: z.ZodIssueCode.custom,
      path: ["PDA_GRANT_PEPPER"],
      message: "PDA_GRANT_PEPPER is required in production"
    });
  }
});
