...
const REQUIRED_IDS = [
  ...
  "physicalInventoryPrepareBtn",
  "physicalInventoryConfirmBtn",
  "physicalInventoryPrepareModal",
  "physicalInventoryConfirmModal",
  "importWizardPanel"
];
...
test("dashboard.js usa v=55", () => {
  assert.match(html, /dashboard\.js\?v=55/);
  assert.doesNotMatch(html, /dashboard\.js\?v=54/);
});
