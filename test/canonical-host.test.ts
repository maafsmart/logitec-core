...
test("dashboard.html carga canonical-host.js antes de dashboard.js", () => {
  ...
  const dash = dashboardHtml.indexOf("dashboard.js?v=92");
...
test("se conservan compact-workspace-v1, server-cancel-v1 y dashboard.js?v=92", () => {
  ...
  assert.match(dashboardHtml, /dashboard\.js\?v=92/);
